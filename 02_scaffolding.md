...
> **本章目标**：搭建项目脚手架，配置 CLAUDE.md 驯服 AI
>
> | 章节 | 关键词 |
> |:-----|:------|
> | Ch0 生态概览 | 工具选型 · 开发模式 |
...
## 设计思维：顺序工作流（Sequential Workflow）
...
- [Anthropic 官方文档 — CLAUDE.md](https://docs.anthropic.com/en/docs/claude-code/memory)
- [CLAUDE.md 快速入门（5 分钟上手）](https://smartscope.blog/en/ai-development/claude-md-introduction/)
- [CLAUDE.md 定制指南（2026）](https://www.gend.co/blog/customise-claude-code-with-claude-md)
- [Claude Code 环境配置最佳实践](https://www.maxzilla.nl/blog/claude-code-environment-best-practices/)
- [typer 官方文档](https://typer.tiangolo.com/)

---

[上一章: Ch1 — 项目规划](01_planning.md) | [下一章: Ch3 — 理解变更](03_git_diff.md)
