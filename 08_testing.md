...
> **本章目标**：为 Review Bot 添加测试，掌握 TDD with AI 流程
>
> | 章节 | 关键词 |
> |:-----|:------|
> | Ch0 生态概览 | 工具选型 · 开发模式 |
...
- [TDD with AI — 测试驱动的 AI 开发](https://martinfowler.com/articles/exploring-gen-ai.html)
- [Anthropic 官方文档 — Hooks](https://docs.anthropic.com/en/docs/claude-code/hooks)

---

[上一章: Ch7 — 自动化](07_automation.md) | [下一章: Ch9 — 模板库](09_templates.md)
